      ...
      <div className="space-y-8">
        ...
        <section>
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            <div className="space-y-4">
              <div>
                <h3 className="font-medium mb-1">Sistem Desteği</h3>
                <p className="text-gray-600">0507 940 09 15</p>
              </div>
              <div>
                <h3 className="font-medium mb-1">Teknik E-posta</h3>
                <p className="text-gray-600">aliogluuabdullah@gmail.com</p>
              </div>
              <div>
                <h3 className="font-medium mb-1">Destek Saatleri</h3>
